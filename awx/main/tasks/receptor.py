    ...
    def _run_internal(self, receptor_ctl):
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=2) as executor:
            ...
            if res.status == 'canceled':
                ...
                logger.info("[DEBUG3] before checking traceback")
